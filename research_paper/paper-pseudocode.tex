...
\If{$\ell = Red$} \Return Critical \EndIf
\State \Return nil
\EndFunction
...
\If{$t_i < t_y \land o.d < d_{\text{req}}$} \Return Warning \EndIf
\EndIf
\EndIf
\EndFor
\State \Return nil
...
\If{$\ell = Yellow \land t_y < 2.5$} \Return Caution \EndIf
\State \Return nil
\EndFunction
\Function{RuleStale}{$\ell, v_e, d_s$}
\If{$\ell = Green \land d_s > StoppingDistance(v_e)$}
\State \Return Caution \Comment{Worst-case: green may end at any frame}
\EndIf
\State \Return nil
\EndFunction
\end{algorithmic}
