...
users and multi-lane crossing scenes; and (iv)~a simulation-based evaluation
campaign in SUMO or CARLA~\cite{lopez2018,dosovitskiy2017} with randomised
intersection approaches and baseline comparison, complementing the
