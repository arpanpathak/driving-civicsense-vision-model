...
this work. The Jetson ecosystem's support for ONNX Runtime, INT8
quantisation, and low-power edge deployment made the real-time
distributed pipeline architecture (Pico $\rightarrow$ Pi Zero
$\rightarrow$ Jetson $\rightarrow$ KMP companion) feasible at a price
point that makes civic AI accessible.
