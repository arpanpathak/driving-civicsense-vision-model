...
\DeclareRobustCommand{\warnicon}{%
  \tikz[baseline=(current bounding box.center), scale=0.22]{%
...
\midrule
\warnicon~1 & Decision & Signal timing & V2I / SPaT; otherwise worst-case geometry (Remark~\ref{rem:worstcase}) \\
\warnicon~2 & Perception & Bounding-box jitter & $\pm 1.5$~m $\approx 100$~ms; a confidence score is not a formal bound \\
\warnicon~3 & Decision & Lead-vehicle motion & leader deceleration $\leq 0.4g$ (Remark~\ref{rem:leadbound}) \\
\warnicon~4 & HMI & Trust erosion & false positives get ignored; dynamic threshold by reaction time \\
\warnicon~5 & Perception & Occlusion & stop line hidden; outside the formal scope \\
\warnicon~6 & Decision & Road friction & grip fixed at $4.0$~\si{m/s^2} \\
\bottomrule
\end{tabular}
\end{table*}
