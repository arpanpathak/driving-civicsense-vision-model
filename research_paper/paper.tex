...
\textbf{1) Signal timing.} Without V2I or a SPaT (signal phase and
...
\textbf{2) Perception uncertainty.} Neural network outputs are
...
bound.
\textbf{4) HMI trust.} Frequent false positives erode driver trust
...
\textbf{5) Occlusion.} A large vehicle can hide the stop line or
the lead vehicle entirely; such detection gaps lie outside the formal scope.
\textbf{6) Road friction.}
